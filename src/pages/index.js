...
const IndexPage = ({ data }) => {
    ...
    return (
        <Layout>
            <section className="relative h-[24rem] md:h-[30rem] z-0 mx-auto">
                ...
                <div className="flex flex-col max-w-screen-2xl mx-auto items-center justify-center h-full w-full text-center px-1">
                    <h1
                        data-sal="slide-up"
                        data-sal-delay="200"
            ...
            {allDatoCmsS2.edges.map(({ node }) => (
                <section className="pt-6 md:pt-8 lg:pt-24">
                    <h5 className="mx-auto text-center text-sm text-yellow-500 tracking-widest font-medium title-font mb-3">Rejestracja zabytków na żółte tablice</h5>
                    <h3
                        data-sal="slide-up"
                        data-sal-delay="0"
                        data-sal-duration="600"
