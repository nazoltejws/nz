        ...
        <Layout>
            <div className="text-white flex flex-col items-center justify-center px-5 py-5 lg:py-12">
                ...
                {allDatoCmsFaktyMity.edges.map(({ node }) => (
                    ...
                    >
                        {" "}
                        <h2 data-sal="slide-down"
                            data-sal-delay="0"
                            data-sal-duration="600"
                            data-sal-easing="ease" className="text-2xl lg:text-3xl flex items-center justify-center w-full text-center uppercase mb-2 text-yellow-500 tracking-wider shadowScale font-bold">
                            {node.tytul}
                        </h2>
                        <div
